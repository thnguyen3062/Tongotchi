...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnapEditor : SSSCopyrightEditor
    {
        ...
        private SerializedProperty movementType, notRequireEqualToggle, movementAxis, useAutomaticLayout, sizeControl, size, automaticLayoutSpacing, automaticLayoutMargins, useInfiniteScrolling, infiniteScrollingSpacing, useOcclusionCulling, startingPanel, useSwipeGestures, minimumSwipeSpeed, previousButton, nextButton, pagination, useToggleNavigation, snapTarget, snapSpeed, thresholdSpeedToSnap, useHardSnapping, useUnscaledTime, onTransitionEffects, onPanelSelecting, onPanelSelected, onPanelCentering, onPanelCentered;
        ...
        private void OnEnable()
        {
            ...
            notRequireEqualToggle = serializedObject.FindProperty("notRequireEqualToggle");
        ...
        private void ShowPagination()
        {
            ...
            if (scrollSnap.Pagination != null)
            {
                ...
                EditorGUILayout.PropertyField(notRequireEqualToggle, new GUIContent("Toggle Not Require bla bla"));
                int numberOfToggles = scrollSnap.Pagination.transform.childCount;
                if (numberOfToggles != scrollSnap.NumberOfPanels && !scrollSnap.NotRequireEqualToggle)
                {
